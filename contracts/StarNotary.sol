...
contract StarNotary is ERC721 {
    ...
    string public constant name = 'StarTokenNotary';
    ...
    function lookUptokenIdToStarInfo(uint _tokenId) public view returns (string memory) {
        ...
        string memory startName = tokenIdToStarInfo[_tokenId].name;
        return startName;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((msg.sender == ownerTokenId1) || (msg.sender == ownerTokenId2),
            "The sender doesn't own any of the starts");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Sender isn't the owner of the token.");
